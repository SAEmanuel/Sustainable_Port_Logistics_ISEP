...
public class CreatingShippingAgentRepresentativeDto
{
    ...
    public CreatingShippingAgentRepresentativeDto(string name, CitizenId citizenId, Nationality nationality, string email, string phoneNumber, string status, string sao)
    {
        Name = name;
        CitizenId = citizenId;

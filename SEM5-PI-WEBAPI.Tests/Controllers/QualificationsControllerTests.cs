...
//         _controller = new QualificationsController(_serviceMock.Object, _loggerMock.Object, _refrontendMock.Object);
//
...
//     {
//         _serviceMock.Setup(s => s.GetByIdAsync(It.IsAny<QualificationId>())).ThrowsAsync(new BusinessRuleValidationException("Qualification not found"));
//         
...
//     {
//         _serviceMock.Setup(s => s.GetByCodeAsync(It.IsAny<string>())).ThrowsAsync(new BusinessRuleValidationException("Qualification not found"));
//
...
//     {
//         _serviceMock.Setup(s => s.GetByNameAsync(It.IsAny<string>())).ThrowsAsync(new BusinessRuleValidationException("Qualification not found"));
//
//         var result = await _controller.GetByName("Qualification1");
//
//         var nf = Assert.IsType<NotFoundObjectResult>(result.Result);
//         Assert.Contains("Qualification not found", nf.Value.ToString());
//     }
